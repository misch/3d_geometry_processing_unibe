...
import glWrapper.GLHashtreeAdjacentVertices;
...
public class AdjacentVerticesDemo {
	...
	public static void hashTreeDemo(PointCloud pc){
		...
		GLHashtreeAdjacentVertices glOT = new GLHashtreeAdjacentVertices(tree);
		GLHashtree glOT2 = new GLHashtree(tree);

		glOT.configurePreferredShader("shaders/octree.vert",
		"shaders/octree.frag",
		"shaders/octree_adjacent_vertices.geom");
